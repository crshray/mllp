...
var (
	...
	logNACKedMsg          = flag.Bool("log_nacked_msg", false, "[Optional] Whether to log the messages that receive NACK from the API; be careful about the PHI implication as this may leave the messages in your log output")
